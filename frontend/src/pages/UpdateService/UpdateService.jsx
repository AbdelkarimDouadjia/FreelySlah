  ...
  useEffect(() => {
    const fetchServiceDetails = async () => {
      try {
        ...
        console.log(service);
        setGigId(service._id);
        setServiceTitle(service.title);
        setServiceCategory(service.category);
        setServiceSubCategory(service.subCategory);
        setServiceSearchTags(service.serviceSearchTags);
        setPricingTiers(service.pricingTiers);
        setServiceImages(service.serviceImages);
        setCoverImage(service.coverImage);
        setServiceRequirements(service.serviceRequirement);
        setServiceDescription(service.serviceDescription);
        setMaxProjects(service.maxProjects);
      } catch (err) {
