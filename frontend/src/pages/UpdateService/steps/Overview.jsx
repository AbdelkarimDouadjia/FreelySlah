...
const Overview = () => {
  ...
  // Effect to initialize state from context on mount
  useEffect(() => {
    setTitle(updateContext.serviceTitle.replace("You will get ", "") || "");
    setServiceCategory(updateContext.serviceCategory || "Web Design");
    setServiceSubCategory(updateContext.serviceSubCategory || "UI/UX Design");
    setTags(updateContext.serviceSearchTags || []);
  }, [updateContext]);
  ...
  const handleAddTag = (event) => {
    ...
    if (newTag.trim()) {
      ...
      setTags(updatedTags);
      updateContext.setServiceSearchTags(updatedTags);
      setNewTag("");
              ...
              <div className="mb-7">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setTempServiceSubCategory(
                      categories[e.target.value][0] || ""
                    );
                  }}
                >
