...
const Publish = () => {
  ...
  useEffect(() => {
    if (updateContext.maxProjects) {
      setMaxProjects(updateContext.maxProjects);
    }
  }, [updateContext.maxProjects]);
  ...
  const finish = async () => {
    if (!maxProjects) {
      ...
      try {
        await newRequest.put(`/gigs/${updateContext.gigId}`, {
          userId: `${userInfo._id}`,
    ...
    >
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            updateContext.setMaxProjects(e.target.value);
          }}
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-[#181818]">
          ...
          FreelySlah to ensure it meets FreelySlah’s requirements.
        </p>
      </div>
        ...
        <div className={styles.checkboxContainer}>
          ...
          <label htmlFor="terms" className="text-sm text-[#181818]">
            ...
            <a
              ...
              className="text-[#0E9F6E] underline"
            >
              FreelySlah Terms of Service
            </a>
            , including the{" "}
            <a
      ...
      <div className="mb-6">
        ...
        <div className={styles.checkboxContainer}>
          ...
          <label htmlFor="privacy" className="text-xs text-[#181818] w-[100%]">
            ...
            will appear in FreelySlah search results visible to the general
            public and will show up in search engine results, even if my profile
            visibility is set to Private or FreelySlah Users Only.
          </label>
        </div>
      </div>
