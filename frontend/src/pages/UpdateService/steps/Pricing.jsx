...
const Pricing = () => {
  ...
  useEffect(() => {
    if (updateContext.pricingTiers) {
      setPricingTiers(updateContext.pricingTiers);
    }
  }, [updateContext.pricingTiers]);
  ...
  const handleInputChange = (index, field, value) => {
    ...
    updateContext.setPricingTiers(newTiers); // Immediate context update
  };
