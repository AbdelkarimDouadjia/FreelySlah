        ...
        <form className="form">
          <label>
            <select
              ...
              onChange={(e) => updateContext.setBrand(e.target.value)}
            >
          ...
          <label>
            <select
              className="formSelect"
              onChange={(e) => updateContext.setModel(e.target.value)}
            >
          ...
          <label>
            <select
              className="formSelect"
              onChange={(e) => updateContext.setYear(e.target.value)}
            >
          ...
          <input
            ...
            onChange={(e) => updateContext.setValue(e.target.value)}
          />
