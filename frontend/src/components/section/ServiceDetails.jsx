...
export default function ServiceDetails(props) {
  ...
  const getOption = (tier, option) => {
    return tier.options[option] ? (
      ...
      <a className="rounded-[50%] text-white text-[8px] h-[25px] leading-[25px] text-center w-[25px] bg-[#e9e9e9] cursor-pointer transition-all duration-300 ease-linear flex items-center justify-center">
        <span className="fas fa-times font-black" />
      </a>
    );
  };
              ...
              <div className="shrink-0 w-full max-w-full px-3 min-[992px]:flex-initial min-[992px]:flex-shrink-0 min-[992px]:w-2/3 ">
                <div className="column">
                        ...
                        <div className="mt-[30px] flex flex-wrap ">
                          ...
                          >
                            <span className="mr10 relative mr-[10px]">
                              ...
                              />
                              {userService.isOnline ? (
                                <span className="bg-[#5bbb7b] border-2 border-white absolute rounded-[50%] left-[30px] top-0 h-[9px] w-[9px] max-[575.98px]:right-0"></span>
                              ) : (
                                <span className="bg-red-700 border-2 border-white absolute rounded-[50%] left-[30px] top-0 h-[9px] w-[9px] max-[575.98px]:right-0"></span>
                              )}
                            </span>
                            <span className="text-sm">
                              {userService.fname} {userService.lname}
                            </span>
                          </a>
                  ...
                  <div className="service-about">
                    ...
                    {data ? (
                      <div
                        dangerouslySetInnerHTML={{
                          __html: DOMPurify.sanitize(data.serviceDescription),
                        }}
                      ></div>
                    ) : (
                      <div>
                        ...
                        <tbody className="t-body border-t-0 align-bottom border-solid">
                          <tr className="bgc-thm3 border-t border-[#e9e9e9]">
                            ...
                            {pricingTiers.map((tier, index) => (
                              <td
                                key={index}
                                className="px-2 py-[30px] font-normal border-b-0 bg-inherit"
                              >
                                {getOption(tier, "sourceFiles")}
                              </td>
                            ))}
                          </tr>
                          <tr className="bgc-thm3 border-t border-[#e9e9e9]">
                    ...
                    <ServiceDetailReviewInfo gigId={data._id} />
                  </div>
                </div>
              </div>
                ...
                <div className="column">
                    <div className="scrollbalance-inner">
                      <div className="blog-sidebar max-w-[370px] min-[992px]:ml-auto">
                        <ServiceDetailPrice data={data} />
                        <ServiceContactWidget data={userService} />
                      </div>
                    </div>
                </div>
              </div>
