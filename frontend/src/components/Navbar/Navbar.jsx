        ...
        <div className="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
          <div className="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg
                    ...
                    viewBox="0 0 20 20"
                    className={classNames(
                      "inline w-4 h-4 mt-1 ml-1 transition-transform duration-200 transform",
              ...
              <button className="bg-green-500 text-white rounded-full px-4 py-2 mt-2 ml-4">
                Login
              </button>
              <button className="border border-black text-black rounded-full px-4 py-2 mt-2 ml-4">
                Signup
              </button>
            </nav>
          </div>
